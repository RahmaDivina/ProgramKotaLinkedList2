...
//		printf("Warga %s Berhasil Dihapus !",X);
		...
		printf("Tidak ditemukan warga dengan nama tersebut");
	}
}
...
infotype AlokasiInfotype() //! baru
{
    infotype temp = (infotype)malloc(sizeof(infotype) * NAMA);
    if (temp == Nil)
    {
        printf("MEMORI PENUH, PROGRAM KELUAR...\n");
    }
    return temp;
}
